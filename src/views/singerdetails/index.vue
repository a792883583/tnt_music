                ...
                <div class="singer-info">
                    ...
                    <div class="singer-name">
                        ...
                        <template v-if="singeralias && singeralias.length > 0">
                            <span
                                v-for="(item, index) in singeralias"
                                :key="index"
                                >{{ item }}</span
                            >
                        </template>
                ...
                <ul class="album" ref="album">
                    ...
                    >
                        ...
                        <div class="songer-info">
                            <p>{{ item.name }}</p>
                            <p v-for="(its, idx) in item.alias" :key="idx">
                                {{ its }}
                            </p>
                        </div>
                    </li>
                            ...
                            >
                                ...
                                <div class="songers-info">
                                    <div class="songer-nameSinger">
                                        <h5>{{ item.name }}</h5>
                                        <template
                                            v-if="item.ar && item.ar.length > 0"
                                        >
                                            <p
                                                v-for="(data, idx) in item.ar"
                                                :key="idx"
                                            >
                                                {{ data.name }}
                                            </p>
